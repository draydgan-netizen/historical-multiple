...
def main(page: ft.Page):
            ...
            scrollable_results.content = ft.Container(
                content=ft.Column([
                    ...
                    ft.Card(
                        content=ft.Container(
                            content=ft.Column([
                                ft.Text("Historical Multiple Analysis", 
                                       size=18, 
                                       weight=ft.FontWeight.W_600,
                                       color=ft.Colors.WHITE),
                                ft.Row([
                                ...
                                ft.Container(
                                    content=ft.Text(
                                        f"The Historical Multiple has historically been higher than the current value {higher_than_today:.2f}% of the time.",
                                        size=14,
                                    ...
                                    ft.Container(
                                        content=ft.Column([
                                            ft.Row([
                                                ...
                                                ft.Text(f"Return: {best_thresholds[period][1]:.2%}", 
                                                       size=14, 
                                                       weight=ft.FontWeight.W_500,
                                                       color=ft.Colors.GREEN_400)
                                            ], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
                                            ft.Text(
                                                f"Best buy below {best_thresholds[period][0]:.2f}",
                                                size=13,
                                                color=ft.Colors.GREY_300
                                            )
                                        ], spacing=8),
    ...
    ticker_input = ft.TextField(label="Enter the stock ticker (Example: AAPL):")
    fetch_button = ft.ElevatedButton(text="Search Stock", on_click=fetch_data)
    
    results_container = ft.Container(
        content=ft.Container(
            content=ft.Column([
                ft.Icon(ft.Icons.SEARCH, color=ft.Colors.GREY_600, size=64),
                ft.Text("Enter a ticker and click 'Search Stock' to see the results", 
                       size=16, 
